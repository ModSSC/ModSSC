...
class SklearnExtraTreesClassifier(SklearnProbaClassifier):
    ...
    def fit(self, X: Any, y: Any) -> FitResult:
        ...
        sklearn_ensemble = optional_import(
            "sklearn.ensemble", extra="sklearn", feature="supervised:extra_trees"
        )
        ExtraTreesClassifier = sklearn_ensemble.ExtraTreesClassifier
