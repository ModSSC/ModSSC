...
def _torch_geometric():
    torch = optional_import("torch", extra="supervised-torch-geometric", feature="supervised:graphsage_inductive")
    try:
...
class TorchGraphSAGEClassifier(BaseSupervisedClassifier):
    ...
    def fit(self, X: Any, y: Any, **kwargs) -> FitResult:
        ...
        if not isinstance(X, dict):
             ...
             raise ValueError("TorchGraphSAGEClassifier requires a dictionary with 'x' and 'edge_index' keys as X.")
