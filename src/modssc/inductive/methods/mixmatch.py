...
class MixMatchMethod(TorchBundlePredictMixin, InductiveMethod):
    ...
    def execution_contract(
        ...
        uses_manifold = bool(spec.mixup_manifold) or (
            spec.model_bundle is not None and _bundle_prefers_manifold_mixup(spec.model_bundle)
        )
        ...
        return replace(
            ...
            components=tuple(
                replace(
                    ...
                    output_alternatives=manifold_alternatives,
