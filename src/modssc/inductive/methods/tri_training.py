...
class TriTrainingMethod(InductiveMethod):
    ...
    def predict_evaluation_outputs(self, X: Any) -> dict[str, Any]:
        """Expose the retained round-zero ensemble as a named diagnostic."""

        if not self._initial_clfs:
            return {}
        return {"initial": self.predict_proba_initial(X)}
    ...
    def record_evaluation_metrics(
        ...
        *,
        ...
        """Retain legacy round-zero diagnostics without runner coupling."""
