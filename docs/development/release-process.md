...
This page explains how to cut a release and what CI does for the documentation site and packages. For contributor setup, see [Contributing and development](contributing.md).
...
The build and release dependencies are declared in the development extras of [`pyproject.toml`](https://github.com/ModSSC/ModSSC/blob/main/pyproject.toml). <sup class="cite"><a href="#source-2">[2]</a></sup>


## How docs are published
The documentation site is built with MkDocs Material and deployed to GitHub Pages on pushes to `main` and on release tags. <sup class="cite"><a href="#source-8">[8]</a><a href="#source-4">[4]</a></sup>
