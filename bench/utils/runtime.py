...
from modssc.runtime.software import attach_software_manifest
...
def collect_runtime_versions(
    *,
    ...
    # NumPy and SciPy are core ModSSC scientific dependencies. Every other
    # distribution is selected by the materialized component manifest supplied
    # by the runner.
    return attach_software_manifest(
        out,
        required_distributions=("numpy", "scipy", *required_distributions),
        version_getter=_pkg_version,
