...
from bench.main import _method_requires_torch
from bench.regimes import labels_per_class
...
def _replication_method_requires_torch(method_id: str) -> bool:
    return _method_requires_torch(method_id, strict=True)
...
def test_all_best_configs_follow_benchmark_contract() -> None:
    ...
    for path, raw in configs:
        ...
        expected_budget = labels_per_class(regime)
