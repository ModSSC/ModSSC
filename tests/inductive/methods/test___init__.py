...
import modssc.inductive.methods as methods
...
def test_lazy_method_exports_resolve_known_symbols() -> None:
    assert methods.SetredMethod is setred.SetredMethod
    assert methods.VATMethod is vat.VATMethod


from ._methods_classic import *  # noqa: E402,F401,F403
from ._methods_deep import *  # noqa: E402,F401,F403
