...
def test_match_methods_expose_protocol_dependent_unlabeled_index_space(
    method_cls: Any,
    spec_cls: Any,
) -> None:
    assert method_cls(spec_cls()).unlabeled_index_space == "source"
    assert method_cls(spec_cls(training_mode="fixed_steps")).unlabeled_index_space == "local"
